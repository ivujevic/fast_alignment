...
extern void getCodes(const std::string& sequence, std::vector<long>& results, int kmer_len);
extern void getCodes(const std::string& sequence, std::vector<std::pair<long,long>>& results,int kmer_len);
