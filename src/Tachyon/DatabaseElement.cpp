...
DatabaseElement::DatabaseElement(const std::string& name, int nameLen, const std::string& sequence, const int seqLen,
                                 const int id)
        : name_(std::move(name)), nameLen_(nameLen), sequence_(std::move(sequence)), sequenceLen_(seqLen), id_(id) {
